...
// EstIssuerStatus defines the observed state of EstIssuer.
type EstIssuerStatus struct {
	...
	// conditions represent the current state of the EstIssuer resource.
...
type EstIssuer struct {
	...
	// spec defines the desired state of EstIssuer
	// +required
	Spec EstIssuerSpec `json:"spec"`

	// status defines the observed state of EstIssuer
	// +optional
	Status EstIssuerStatus `json:"status,omitzero"`
}
